        ...
        <form>
          <div className="fields">
            ...
            <label className="start-date gr">
              <h3>Start Date:</h3>
              <input type="date" className="time" id="startDate" placeholder="date" onChange={this.handleInputChange}/>
            </label>
            <label className="end-date gr">
              <h3>End Date:</h3>
              <input type="date" className="time" id="endDate" placeholder="date" onChange={this.handleInputChange}/>
            </label>
            <label className="all-day gr">
              <h3>All Day:</h3>
              <input type="text" className="time" id="allDay" placeholder="All Day" onChange={this.handleInputChange}/>
            </label>
